...
bool GamePlayLayer::init()
{
	...
	do
	{
		...
		// Add the menu to GamePlayLayer layer as a child layer.
		...
		this->schedule( schedule_selector(GamePlayLayer::gameLogic), 1.0 );
		...
		this->schedule( schedule_selector(GamePlayLayer::updateGame) );
...
void GamePlayLayer::addTarget()
{
	...
	CCFiniteTimeAction* actionMoveDone = CCCallFuncN::create( this,
                                                             callfuncN_selector(GamePlayLayer::spriteMoveFinished));
...
void GamePlayLayer::spriteMoveFinished(CCNode* sender)
{
...
void GamePlayLayer::updateGame(float dt)
{
